FROM ghcr.io/yesodweb/yesodweb.com/base-build:880b1ff1eb3db055885024974dd67bdb8c0e2484 as build-app

RUN mkdir -p /artifacts/bin
COPY . /src
RUN stack install --stack-yaml /src/stack.yaml --local-bin-path /artifacts/bin

FROM ghcr.io/yesodweb/yesodweb.com/base-run:880b1ff1eb3db055885024974dd67bdb8c0e2484
